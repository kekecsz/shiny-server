...
# Call modules
# setwd("C:\\Users\\User\\Dropbox\\_Real_time")
...
source("Continuous_research_demo\\modules\\notification_module.R")
source("Continuous_research_demo\\modules\\generate_preprint_module.R")

# Define UI parts
## Define header

header <- dashboardHeader(title = "Real-time Research Report",
